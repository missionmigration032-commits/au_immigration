...
function ImmiAccountLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      alert("Login error. Please verify backend server is running.");
      console.error(error);
    }
  };
        ...
        <div className="immi-content-container">
          <div className="immi-info-box">
            ...
            <div className="immi-info-body">
              <h3>
                Temporary travel restrictions for Iranian Visitor visa holders
              </h3>
              <p>
                For more information see{" "}
                <a href="#">
                  Temporary travel restrictions for Visitor visa holders with
                  Iranian passports
                </a>
                .
              </p>
          ...
          <div className="immi-section">
            ...
            <p className="immi-mandatory-text">
              Fields marked <span className="req">*</span> must be completed.
            </p>
            ...
            <div className="immi-actions-bar">
              ...
              <button className="immi-btn-submit" onClick={handleLogin}>
                Login
              </button>
            </div>
            ...
            <div className="immi-forgot-links">
              <p>
                I have forgotten my ImmiAccount <a href="#">username</a> or{" "}
                <a href="#">password</a>
              </p>
              <p>
                I no longer have access to my{" "}
                <a href="#">multi-factor authentication app</a>
              </p>
            </div>
          </div>
